...
class cell2spots3D:
    """
    This class implements an algorithm for Visium that maps each cell to its spot.
    """
    def __init__(
        self,
        S,
...
# model for strips(not implemented yet)
class cell2spots_strips:
    """
    This class implements an algorithm that maps each cell to its spot from strips bulk RNA seq.
    """
    def __init__(
        self,
        S,
